 ...
 * Slug: {fixrs}/footer-three-columns
 * Categories: footer
...
<div class="wp-block-group alignfull has-small-font-size" style="margin-top:0rem;padding-top:var(--wp--preset--spacing--small);padding-right:3.0rem;padding-bottom:var(--wp--preset--spacing--small);padding-left:3.0rem">
	...
	<div class="wp-block-group alignwide">
		...
		<!-- /wp:paragraph -->
		<!-- wp:social-links {"iconColor":"base","iconColorValue":"#fff","iconBackgroundColor":"contrast","iconBackgroundColorValue":"#000","style":{"spacing":{"blockGap":"1.0rem"}},"className":"is-style-default"} -->
