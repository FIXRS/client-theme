...
<div class="wp-block-group alignwide">
	...
	<div class="wp-block-columns alignwide are-vertically-aligned-center is-style-columns-reverse">
		...
		<div class="wp-block-column is-vertically-aligned-center">
			...
			<h2 class="wp-block-heading has-x-large-font-size" id="sample-heading"><?php echo esc_html__( 'Build with Gutenberg', '{fixrs}-theme' ); ?></h2>
			<!-- /wp:heading -->
			<!-- wp:paragraph -->
			<p><?php echo esc_html__( 'Gutenberg is a powerful WordPress theme created for agencies and professional website builders. With its clean, minimal design, Gutenberg provides the perfect canvas for sophisticated websites.', '{fixrs}-theme' ); ?></p>
			<!-- /wp:paragraph -->
			<!-- wp:buttons -->
			<div class="wp-block-buttons"><!-- wp:button -->
			<div class="wp-block-button"><a class="wp-block-button__link wp-element-button"><?php echo esc_html__( 'View Project', '{fixrs}-theme' ); ?></a></div>
			<!-- /wp:button --></div>
			<!-- /wp:buttons -->
		</div>
		<!-- /wp:column -->
