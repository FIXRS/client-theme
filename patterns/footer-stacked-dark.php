 ...
 * Slug: {fixrs}/footer-stacked-dark
 * Categories: footer
...
?>
<!-- wp:group {"align":"full","style":{"elements":{"link":{"color":{"text":"var:preset|color|base"}}},"spacing":{"padding":{"top":"var:preset|spacing|x-large","bottom":"var:preset|spacing|small","right":"3.0rem","left":"3.0rem"},"margin":{"top":"0rem"}}},"backgroundColor":"contrast","textColor":"base","className":"has-background-color","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull has-background-color has-base-color has-contrast-background-color has-text-color has-background has-link-color" style="margin-top:0rem;padding-top:var(--wp--preset--spacing--x-large);padding-right:3.0rem;padding-bottom:var(--wp--preset--spacing--small);padding-left:3.0rem">
	...
	<p class="has-text-align-center has-small-font-size">&copy; <?php echo esc_html( gmdate( 'Y' ) ); ?> <?php echo esc_html__( 'Your Company LLC', '{fixrs}-theme' ); ?> · <a href="#"><?php echo esc_html__( 'Contact Us', '{fixrs}-theme' ); ?></a></p>
	<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
