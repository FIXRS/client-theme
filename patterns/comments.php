...
<section class="wp-block-group entry-comments" style="margin-top:var(--wp--preset--spacing--medium)">
	...
	<div class="wp-block-comments wp-block-comments-query-loop">
		<!-- wp:heading --><h2><?php echo esc_html__( 'Comments', '{fixrs}-theme' ); ?></h2><!-- /wp:heading -->
		...
		<div class="wp-block-group" style="margin-bottom:var(--wp--preset--spacing--medium)">
			...
			<article class="wp-block-group" style="margin-bottom:var(--wp--preset--spacing--small)">
				<!-- wp:group {"tagName":"header","style":{"spacing":{"blockGap":"1.0rem"}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
				<header class="wp-block-group">
					<!-- wp:avatar {"size":48,"style":{"border":{"radius":"2.4rem"}}} /-->
					<!-- wp:group {"style":{"spacing":{"blockGap":"0"}},"layout":{"type":"default"}} -->
					<div class="wp-block-group">
						<!-- wp:comment-author-name /-->
						<!-- wp:group {"style":{"spacing":{"blockGap":"1.0rem"}},"layout":{"type":"flex"}} -->
						<div class="wp-block-group">
							<!-- wp:comment-date /-->
