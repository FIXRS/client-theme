...
?>
<!-- wp:group {"align":"full","style":{"spacing":{"margin":{"top":"0rem"},"padding":{"top":"var:preset|spacing|x-large","bottom":"var:preset|spacing|x-large","left":"3.0rem","right":"3.0rem"}}},"layout":{"type":"constrained"},"fontSize":"small"} -->
<div class="wp-block-group alignfull has-small-font-size" style="margin-top:0rem;padding-top:var(--wp--preset--spacing--x-large);padding-right:3.0rem;padding-bottom:var(--wp--preset--spacing--x-large);padding-left:3.0rem">
